...
export const layouts: LayoutEntry[] = [
    {
        slug: 'blueprint-001',
        name: 'Blueprint 001',
        description: 'Three-column layout with independent scroll and a Tambo chat bar that generates list items.',
    ...
    },
    {
        slug: 'blueprint-002',
        name: 'Blueprint 002',
        description: 'Three-column layout with a slide-over detail panel and contextual Tambo chat that generates section metadata.',
    ...
    },
    {
        slug: 'canvas-001',
        name: 'Canvas 001',
        description: 'Infinite canvas with draggable floating panels and a Tambo chat window that generates new canvas panels.',
        category: 'canvas',
    ...
    },
    {
        ...
        description: 'Musician\'s canvas with draggable beat pads and a Tambo chat window that generates new beat pads.',
        category: 'canvas',
